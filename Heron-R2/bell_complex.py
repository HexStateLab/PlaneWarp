...
from pw_opt import build_circuit, all_syndromes_opt, accumulated_syndromes
...
def main():
    ...
    for arm, pub in zip(("ZZ", "XX"), res):
        ...
        nsh = data.shape[0]
        syn = (all_syndromes_opt(pub, n, r, s, n_anc, no_reset=False)
        ...
        if syn.shape[1] > 0:
            _, stream = accumulated_syndromes(syn, basis)[basis]
        else:
            stream = syn
